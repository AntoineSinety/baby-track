  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        clientsClaim: true,
        runtimeCaching: [
          // Firebase Firestore API - NetworkFirst pour avoir les données les plus récentes
          {
          ...
          // Google Fonts - CacheFirst avec longue durée
          {
          ...
          // Page HTML - NetworkFirst pour avoir la dernière version
          {
            urlPattern: /\.html$/i,
            handler: 'NetworkFirst',
            options: {
